...
public class DlgPropsUnimap extends JDialog implements ActionListener {
	 ...
	 * Create the dialog.
	 */
	public DlgPropsUnimap(CJNavixLayerUnimap vLayerUnimap) {
		layerUnimap = vLayerUnimap;
		setTitle("Unimap Properties");
				...
				buttonPane.add(cancelButton);
				{
					...
					panel.setLayout(new BoxLayout(panel, BoxLayout.Y_AXIS));
					{
						...
						}
						{
							...
							textField.setText(vLayerUnimap.comment);
					...
					}
					{
						...
						panel.add(panel_1);
						{
							...
							chckbxVisible.setSelected(vLayerUnimap.visible);
						}
					}
					{
						JPanel panel_1 = new JPanel();
						...
						panel.add(panel_1);
						{
							...
							chckbxUseOwnParameters.setSelected(vLayerUnimap.useOwnParameters);
						}
					}
					{
						...
						panel.add(scrollPane);
						{
							...
							textPane.setText(vLayerUnimap.getStatistics());
	...
	public void actionPerformed(ActionEvent e) {
		if (e.getActionCommand().equals("OK")) {
			...
			// }
			layerUnimap.comment = this.textField.getText();
			layerUnimap.visible = this.chckbxVisible.isSelected();
			layerUnimap.useOwnParameters = this.chckbxUseOwnParameters.isSelected();
