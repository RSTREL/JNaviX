...
public class DlgPropsDrawBoard extends JDialog implements ActionListener {
	private static final long serialVersionUID = 3901952828573279498L;
	public String comment;
	public boolean visible = true; 
	public boolean useOwnParameters = false; 
	
	private CJNavixLayerDrawBoard layerDrawBoard;
	 ...
	 * Create the dialog.
	 */
	public DlgPropsDrawBoard(CJNavixLayerDrawBoard vLayerDrawBoard) {
		layerDrawBoard = vLayerDrawBoard;
		setTitle("DrawBoard Properties");
				...
				buttonPane.add(cancelButton);
				{
					...
					panel.setLayout(new BoxLayout(panel, BoxLayout.Y_AXIS));
					{
						...
						}
						{
							...
							textField.setText(vLayerDrawBoard.comment);
					...
					}
					{
						...
						panel.add(panel_1);
						{
							...
							chckbxVisible.setSelected(vLayerDrawBoard.visible);
						}
					}
					{
						JPanel panel_1 = new JPanel();
						...
						panel.add(panel_1);
						{
							...
							chckbxUseOwnParameters.setSelected(vLayerDrawBoard.useOwnParameters);
						}
					}
					{
						...
						panel.add(scrollPane);
						{
							...
							textPane.setText(vLayerDrawBoard.getStatistics());
					...
					}
					{
						...
						panel.add(panel_1);
						{
							JLabel lblNewLabel_1 = new JLabel("Toal: 0 records"  );
	...
	public void actionPerformed(ActionEvent e) {
		if (e.getActionCommand().equals("OK")) {
			...
			// }
			layerDrawBoard.comment = this.textField.getText();
			layerDrawBoard.visible = this.chckbxVisible.isSelected();
			layerDrawBoard.useOwnParameters = this.chckbxUseOwnParameters.isSelected();
