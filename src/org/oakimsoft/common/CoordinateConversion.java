...
public class CoordinateConversion
{
  ...
  public MyPoint3d latLon2FP(double latitude, double longitude)
  {
    LatLon2UTM c = new LatLon2UTM();
    return c.convertLatLonToFP(latitude, longitude);
  }
  ...
  private class LatLon2UTM
  {
    ...
    public MyPoint3d convertLatLonToFP(double latitude, double longitude)
    {
