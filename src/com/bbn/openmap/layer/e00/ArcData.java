    ...
    void setC(ArcData d) {
        if (d.type == 0) {
            if (c0 == null)
                ...
                c2 = d;
            if (type == 1)
                d.valeur2 = valeur; // met   niveau l'arc fronti re
        } else if (d.type == 1) {
            if (c1 == null)
                c1 = d;
            else
                c2 = d;
            if (type == 0)
                valeur = d.valeur; // met � niveau l'arc fronti�re
        }
    }
    ...
    void setF(ArcData d) {
        if (d.type == 0) {
            if (f0 == null)
                ...
                f2 = d;
            if (type == 1)
                d.valeur = valeur; // met � niveau l'arc fronti�re
        } else if (d.type == 1) {
            if (f1 == null)
                f1 = d;
            else
                f2 = d;
            if (type == 0)
                valeur2 = d.valeur; // met � niveau l'arc fronti�re
        }
    }
