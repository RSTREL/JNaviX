/*
 * $Header: /cvs/distapps/openmap/src/openmap/com/bbn/openmap/image/wms/DynamicWmsRequestHandler.java,v 1.1.2.4 2007/08/22 15:01:17 phelinek Exp $
 *
...
public class DynamicWmsRequestHandler extends WmsRequestHandler {
    ...
    // nazwy warstw staycznych (mapa portw), �adowanych z pliku properties
    ...
    public DynamicWmsRequestHandler(String scheme, String hostName, int port, String path, Properties props,
        ...
        // zapami�taj nazwy warstw statycznych , aby przy UpdateLayer nie by�y
     ...
     * podstawie wcze�niej za�adowach danych o celach przy czym warstwy ze
...
//                                                // celami Gdynia, Hel,...
//            // wektor u�ywany tylko gdy pojawi� si� nowe warstwy (layers jest
//            // zwyk�a tablica i nie mo�na jej powi�kszy�, wi�c wykorzystuje
//            // wektor kt�ry po�niej zmienie na tablic�)
...
//                for (int j = 0; j < layers.length; j++) { // sprawdz czy wsr�d
//                                                            // nowych warstw nie
//                                                            // ma przypadkiem
//                                                            // warstwy
//                                                            // statycznej (czyli
